...
<html lang="zxx" class="no-js">
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Peminjaman Ruang | UKDW</title>
		...
		<?php $this->load->view('home/include/base_css'); ?>
	</head>
	<body>
		<!-- navbar -->
		<?php $this->load->view('home/include/base_nav'); ?>
		<!-- start banner Area -->
				...
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="single-service">
							<img class="img-fluid" src="<?php echo base_url() ?>assets/img/a1.png" width="100" height="100" alt="">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-service">
							<img class="img-fluid" src="<?php echo base_url() ?>assets/img/a3.png" width="100" height="100" alt="">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-service">
							<img class="img-fluid" src="<?php echo base_url() ?>assets/img/a2.png" width="100" height="100" alt="">
		...
		<!-- End Generic Start -->
		<!-- start footer Area -->
		<?php $this->load->view('home/include/base_footer'); ?>
		<!-- js -->
		<?php $this->load->view('home/include/base_js'); ?>
	</body>
</html>